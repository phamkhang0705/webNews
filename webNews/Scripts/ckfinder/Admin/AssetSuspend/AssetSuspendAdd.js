...
var Unit = function () {
    ...
    this.SubmitServer = function (action, id) {
        ...
        var url = "/AssetSuspend/Create";
        if (action == "Complete" && id == 0) {
            url = "/AssetSuspend/Create";
            active = 1;
        }
        ...
        if (action == "Complete" && id == 1) {
            url = "/AssetSuspend/UpdateAssetSuspendTempSave";
            active = 1;
        }
                ...
                function (rs) {
                    ...
                    if (rs.Status == "01") {
                        Dialog.Alert(rs.Message, Dialog.Success, function () {
                            setTimeout(function () {
                                window.location.href = '/Admin/AssetSuspend';
                            },
                                3000);
                        });
    ...
    this.GetAllStoreByBranch = function (branchCode, controlSelect, optionAll) {
        Sv.AjaxPost({
            Url: '/AssetSuspend/GetStoreByBranchCode',
            Data: {
                branchCode: branchCode
            }
        }, function (response) {
...
var LoadTableDetail = function () {
    ...
    Sv.AjaxPost({
        Url: '/AssetSuspend/GetAssetSuspendDtl',
        Data: {
            id: transId
        }
    }, function (response) {
