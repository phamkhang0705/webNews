...
var Unit = function () {
        ...
        var obj = [
            ...
            Sv.BootstrapTableColumn("String", {
                ...
                formatter: function (value, data, index) {//
                    ...
                    str += "<button data-code='%s' class='delete btn btn-primary btn-in-table' title='Xóa'><i class='fa fa-remove'></i></button>";
                ...
                events: {
                    'click .OpenEditItem': function (e, value, row, index) {
                        Sv.ChecPermission("View", function () {
                            var url = "/Admin/EducationProgram/ShowModal";
                            var model = {
                    ...
                    'click .delete': function (e, value, row, index) {
                        Dialog.ConfirmCustom("", "Bạn có chắc chắn xóa không?", function() {
                            Sv.AjaxPost({
                                Url: "/Admin/EducationProgram/Delete",
                                    Data: {id : row.Id}
                                },
                                function (rs) {
    ...
    this.SubmitServer = function (action, id) {
        ...
        var url = "/EducationProgram/Create";
        if (action == "Edit") {
            url = "/EducationProgram/Update";
        }
        if ($form.valid(true)) {
            Sv.AjaxPost({
                    Url: url,
