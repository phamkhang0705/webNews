var Unit = function () {
                ...
                events: {
                    'click .OpenEditItem': function (e, value, row, index) {
                        Sv.ChecPermission("View", function () {
                            var url = "/Admin/BranchManage/ShowModal";
                            var model = {
    ...
    this.SubmitServer = function (action, id) {
        ...
        var url = "/BranchManage/Create";
        if (action == "Edit") {
            url = "/BranchManage/Update";
        }
        if ($form.valid(true)) {
            Sv.AjaxPost({
                Url: url,
    ...
    this.GetFormSearchData = function () {
        var obj = {};
        obj.Code = $('#txtBranchCode').val();
        obj.Name = $('#txtBranchName').val();
        obj.Address = $('#txtBranchAddress').val();
        obj.Phone = $('#txtBranchPhone').val();
        obj.Type = $('#txtBranchType').val();
        obj.Active = $("#txtBranchActive").val();
        return obj;
    }
...
$(document).ready(function () {
    ...
    unit.$table.bootstrapTable(Sv.BootstrapTableOption({
        url: "/Admin/BranchManage/GetData",
