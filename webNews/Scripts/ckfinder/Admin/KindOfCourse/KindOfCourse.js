var Unit = function () {
                ...
                events: {
                    'click .OpenEditItem': function (e, value, row, index) {
                        Sv.ChecPermission("View", function () {
                            var url = "/Admin/KindOfCourseManagerment/ShowModal";
                            var model = {
    ...
    this.LoadTableSearch = function () {
        base.$table.bootstrapTable('refreshOptions', {
            url: "/Admin/KindOfCourseManagerment/GetData",
    ...
    this.SubmitServer = function (action, id) {
        ...
        {
            Sv.AjaxPost({
                Url: "/KindOfCourseManagerment/Delete",
                Data: { Id:id}
            },
                   function (rs) {
                       Sv.EndLoading();
        ...
        else
        {
            ...
            var url = "/KindOfCourseManagerment/Create";
            if (action == "Edit") {
                url = "/KindOfCourseManagerment/Update";
            }
            if ($form.valid(true)) {
                Sv.AjaxPost({
                    Url: url,
