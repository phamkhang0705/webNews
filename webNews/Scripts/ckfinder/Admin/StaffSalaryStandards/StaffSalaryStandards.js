var Unit = function () {
    ...
    this.Columns = function () {
        var obj = [
            Sv.BootstrapTableColumn("string", {
                ...
                title: 'Phụ cấp',
                field: 'ConfigInsurranceAllowanceName',
                align: "left",
                width: "150px",
            }), Sv.BootstrapTableColumn("string", {
                title: 'Ngày tạo',
                ...
                events: {
                    'click .OpenEditItem': function (e, value, row, index) {
                        Sv.ChecPermission("View", function () {
                            var url = "/Admin/StaffSalaryStandards/ShowModal";
                            var model = {
    ...
    this.SubmitServer = function (action, id) {
        ...
        var url = "/StaffSalaryStandards/Create";
        if (action == "Edit") {
            url = "/StaffSalaryStandards/Update";
        }
        if ($form.valid(true)) {
            Sv.AjaxPost({
                Url: url,
    ...
    this.GetFormSearchData = function () {
        ...
        obj.SalaryStandardId = $('#txtSalaryStandardId').val();
        return obj;
    }
}
$(document).ready(function () {
    ...
    unit.$table.bootstrapTable(Sv.BootstrapTableOption({
        url: "/Admin/StaffSalaryStandards/GetData",
