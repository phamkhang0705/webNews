var Unit = function () {
                ...
                events: {
                    'click .OpenEditItem': function (e, value, row, index) {
                        Sv.ChecPermission("View", function () {
                            var url = "/Admin/ClassManagerment/ShowModal";
                            var model = {
    ...
    this.LoadTableSearch = function () {
        base.$table.bootstrapTable('refreshOptions', {
            url: "/Admin/ClassManagerment/GetData",
    ...
    this.SubmitServer = function (action, id) {
        ...
        else
        {
            ...
            var url = "/ClassManagerment/Create";
            if (action == "Edit") {
                url = "/ClassManagerment/Update";
            }
            if ($form.valid(true)) {
                Sv.AjaxPost({
                    Url: url,
    ...
    this.GetFormSearchData = function () {
        var obj = {};
        obj.Code = $('#txtClassCode').val();
        obj.Name = $('#txtClassName').val();
        obj.BranchCode = $('#ddlBranSearch :selected').val();
