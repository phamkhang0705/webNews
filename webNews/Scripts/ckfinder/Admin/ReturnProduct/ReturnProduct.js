                ...
                events: {
                    'click .OpenEditItem': function (e, value, row, index) {
                        Sv.ChecPermission("View", function () {
                            var url = "/Admin/ReturnProvider/GetInvoiceDetail";
                            var model = {
                            ...
                            Sv.BindPopup(url, model, function (rs) {
                                ...
                                Sv.SetupDateAndSetDefaultNotMaxDate($('#divCreateDate'), row.CreateDate);
                    ...
                    'click .CancleItem': function (e, value, row, index) {
                        if (row.Active == 2) return;
                        Dialog.ConfirmCustom("",
                            "Bạn chắc chắn hủy phiếu không?",
                            function () {
                                Sv.Loading();
                                var url = "/Admin/ReturnProvider/CancleInvoice";
                                if (row.Active == 0)
                                    url = "/Admin/ReturnProvider/DeleteInvoice";
                                Sv.AjaxPost({
                                    Url: url,
...
$(document).ready(function () {
    unit.$table.bootstrapTable(Sv.BootstrapTableOption({
        url: "/Admin/ReturnProvider/GetData",
    ...
    unit.$historyTable.bootstrapTable(Sv.BootstrapTableOption({
        url: "/Admin/ReturnProvider/GetHistoryData",
        queryParams: function (p) {
            return {
    ...
    unit.$boxDetails.on('click', 'button#btnSave', function (e) {
        e.preventDefault();
        Sv.AjaxPost({
            Url: "/Admin/ReturnProvider/Update",
            Data: {
    ...
    unit.$boxDetails.on('click', 'button#btnCancle', function (e) {
        ...
        Dialog.ConfirmCustom("",
            ...
            function () {
                Sv.Loading();
                Sv.AjaxPost({
                    Url: "/Admin/ReturnProvider/CancleInvoice",
    ...
    unit.$boxDetails.on('click', 'button#btnRefund', function (e) {
        e.preventDefault();
        Dialog.ConfirmCustom("",
            "Bạn có chắc chắn muốn trả lại hàng không?",
            function () {
                Sv.Loading();
                Sv.AjaxPost({
                    Url: "/Admin/ReturnProvider/Refund",
    ...
    unit.$boxDetails.on('click', 'button#btnReOpen', function (e) {
        ...
        window.location = "ReturnProvider/Add?code=" + $("#Code").val();
    });
    ...
    unit.$boxDetails.on('click', 'button#btnDelete', function (e) {
        e.preventDefault();
        Dialog.ConfirmCustom("",
            "Bạn có chắc chắn xóa phiếu nhập không?",
            function () {
                Sv.Loading();
                Sv.AjaxPost({
                    Url: "/Admin/ReturnProvider/DeleteInvoice",
