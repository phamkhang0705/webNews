var Unit = function () {
                ...
                events: {
                    'click .OpenEditItem': function (e, value, row, index) {
                        Sv.ChecPermission("View", function () {
                            var url = "/Admin/CategoryManage/ShowModal";
                            var model = {
    ...
    this.GetFormSearchData = function () {
        var obj = {};
        obj.Code = $('#txtCategoryCode').val();
        obj.Name = $('#txtCategoryName').val();
        obj.ParentId = $('#txtParentId').val();
        obj.Active = $("#txtCategoryActive").val();
...
$(document).ready(function () {
    ...
    unit.$table.bootstrapTable(Sv.BootstrapTableOption({
        url: "/Admin/CategoryManage/GetData",
