                ...
                events: {
                    'click .OpenEditItem': function (e, value, row, index) {
                        Sv.ChecPermission("View", function () {
                            var url = "/Admin/StoreCheck/GetInvoiceDetail";
                            var model = {
                    ...
                    'click .CancleItem': function (e, value, row, index) {
                        var url = "/Admin/StoreCheck/CancleInvoice";
                        var msg = "Bạn có chắc chắn muốn hủy không?";
                        if (row.Active == 0){
                            url = "/Admin/StoreCheck/Delete";
...
$(document).ready(function () {
    ...
    unit.$btnOpenAdd.click(function () {
        window.location.href = "/Admin/StoreCheck/Add";
    });

    unit.$boxDetails.on('click', 'button#btnSave', function (e) {
        e.preventDefault();
        Sv.AjaxPost({
                Url: "/Admin/StoreCheck/Update",
                Data: {
    ...
    unit.$boxDetails.on('click', 'button#btnCancle', function (e) {
        ...
        Dialog.ConfirmCustom("",
            ...
            function () {
                Sv.Loading();
                Sv.AjaxPost({
                    Url: "/Admin/StoreCheck/CancleInvoice",
    ...
    unit.$boxDetails.on('click', 'button#btnReOpen', function (e) {
        e.preventDefault();
        window.location = "StoreCheck/Add?code=" + $("#Code").val();
    });
