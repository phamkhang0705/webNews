...
var Unit = function () {
                ...
                events: {
                    'click .OpenEditItem': function (e, value, row, index) {
                        Sv.ChecPermission("View", function () {
                            var url = "/Admin/AdjustAsset/GetInvoiceDetail";
                            var model = {
                    ...
                    'click .CancleItem': function (e, value, row, index) {
                        var url = "/Admin/AdjustAsset/CancleInvoice";
                        var msg = "Bạn có chắc chắn muốn hủy không?";
                        if (row.Active == 0){
                            url = "/Admin/AdjustAsset/Delete";
    ...
    this.SubmitServer = function (action, id) {
        ...
        var url = "/AdjustAsset/Create";
        if (action == "Edit") {
            url = "/AdjustAsset/Update";
        }
        if ($form.valid(true)) {
            Sv.AjaxPost({
                    Url: url,
...
$(document).ready(function () {
    ...
    unit.$btnOpenAdd.click(function () {
        window.location.href = "/Admin/AdjustAsset/Add";
    });

    unit.$boxDetails.on('click', 'button#btnSave', function (e) {
        e.preventDefault();
        Sv.AjaxPost({
                Url: "/Admin/AdjustAsset/Update",
                Data: {
    ...
    unit.$boxDetails.on('click', 'button#btnCancle', function (e) {
        ...
        Dialog.ConfirmCustom("",
            ...
            function () {
                Sv.Loading();
                Sv.AjaxPost({
                    Url: "/Admin/AdjustAsset/CancleInvoice",
    ...
    unit.$boxDetails.on('click', 'button#btnReOpen', function (e) {
        e.preventDefault();
        window.location = "AdjustAsset/Add?code=" + $("#Code").val();
    });
