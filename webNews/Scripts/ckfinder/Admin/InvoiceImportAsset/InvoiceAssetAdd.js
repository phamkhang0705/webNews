...
var Unit = function () {
    ...
    this.SubmitServer = function (action, id) {
        ...
        if (action == "Complete" && !isReopen) {
            url = "/InvoiceImportAsset/Create";
            active = 1;
        }
        if (action == "Complete" && isReopen) {
            url = "/InvoiceImportAsset/Open";
            active = 1;
        }
...
$(document).ready(function () {
    ...
    if (params.code != null && params.code != undefined) {
        ...
        Sv.AjaxPost({
            Url: "/InvoiceImportAsset/GetInvoice",
    ...
    $("#txtSearchProduct").autocomplete({
            ...
            source: function (request, response) {
                $.ajax({
                    url: "/InvoiceImportAsset/GetProductData",
                    type: "POST",
                    dataType: "json",
    ...
    $("#providerSelect").autocomplete({
            ...
            source: function (request, response) {
                $.ajax({
                    url: "/InvoiceImportAsset/GetProviders",
                    type: "POST",
                    dataType: "json",
    ...
    unit.$btnBack.click(function () {
        window.location.href = "/Admin/InvoiceImportAsset";
    });
