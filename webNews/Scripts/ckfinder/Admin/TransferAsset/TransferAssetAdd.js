...
var Unit = function () {
            ...
            Sv.BootstrapTableColumn("string", {
                ...
                events: {
                    'click .OpenDeleteItem': function (value, row, index) {
                        Dialog.ConfirmCustom("Xác nhận", "Bạn có chắc chắn xóa tài sản này? ", function () {
    ...
    this.SubmitServer = function (action, id) {
        ...
        var url = "/TransferAsset/Create";
        if (action == "Complete" && id == 0) {
            url = "/TransferAsset/Create";
            active = 1;
        }
        ...
        if (action == "Complete" && id == 1) {
            url = "/TransferAsset/UpdateTransferAssetTempSave";
            active = 1;
        }
                ...
                function (rs) {
                    ...
                    if (rs.Status == "01") {
                        Dialog.Alert(rs.Message, Dialog.Success, function () {
                            setTimeout(function () {
                                window.location.href = '/Admin/TransferAsset';
                            },
                                3000);
                        });
    ...
    this.GetQuantityToBranch = function (branchCode) {
        Sv.AjaxPost({
            Url: "/TransferAsset/GetAssetData",
            Data: {
                productName: '',
...
var LoadTableDetail = function () {
    ...
    Sv.AjaxPost({
        Url: '/TransferAsset/GetTransferAssetDtl',
        Data: {
            id: transId
        }
    }, function (response) {
