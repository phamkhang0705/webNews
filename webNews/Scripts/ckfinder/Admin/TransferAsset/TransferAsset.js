var Unit = function () {
                ...
                events: {
                    'click .OpenEditItem': function (e, value, row) {
                        Sv.ChecPermission("View", function () {
                            var url = "/Admin/TransferAsset/ShowModal";
                            var model = {
    ...
    this.SubmitServer = function (action, id) {
        ...
        var url = "/TransferAsset/CancelTransferAsset";
        if (action == "Edit" && id == 0) {
            url = "/TransferAsset/UpdateTransferAsset";
        }
        if ($form.valid(true)) {
            if (action == "Edit" && id == 1) {
    ...
    $('#btnExport').on('click', function () {
        Dialog.ConfirmCustom("",
            ...
            function () {
                ...
                window.location = '/TransferAsset/ExportExcel?' +
                    'BranchCode=' + model.BranchCode +
                    '&Domain=' + model.Domain +
                    '&TransferAssetId=' + model.Id +
...
var tableDetail = function (domain, id) {
    ...
    $tableDetail.bootstrapTable({
        ...
        url: '/TransferAsset/GetTransferAssetDetail',
...
var getAllProductByBranch = function (branchCode, controlSelect, optionAll) {
    Sv.AjaxPost({
        Url: '/TransferAsset/GetAllProductByBranch',
        Data: {
...
var getAllStoreByBranch = function (branchCode, controlSelect, optionAll) {
    Sv.AjaxPost({
        Url: '/TransferAsset/GetStoreByBranchCode',
        Data: {
            branchCode: branchCode
        }
    }, function (response) {
...
$(document).ready(function () {
    ...
    unit.$table.bootstrapTable(Sv.BootstrapTableOption({
        url: "/Admin/TransferAsset/GetData",
        queryParams: function (p) {
            return {
                search: unit.$model,
                pageIndex: p.offset,
    ...
    $('#btnExportExcel').on('click', function () {
        Dialog.ConfirmCustom("",
            ...
            function () {
                ...
                window.location = '/TransferAsset/ExportTransferAsset?' +
                    'Active=' + model.Active +
                    '&Code=' + model.Code +
    ...
    unit.$boxDetails.on('click', 'button#btnOpen', function (e) {
        Dialog.ConfirmCustom("",
            ...
            function () {
                ...
                window.location.href = '/Admin/TransferAsset/Add?id=' + id;
            });
    });
    ...
    unit.$btnOpenAdd.click(function () {
        window.location.href = "/Admin/TransferAsset/Add";
    });
