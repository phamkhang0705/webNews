                ...
                events: {
                    'click .OpenEditItem': function (e, value, row, index) {
                        Sv.ChecPermission("View", function () {
                            var url = "/Admin/InvoiceOutport/GetInvoiceDetail";
                            var model = {
                    ...
                    'click .CancelItem': function (e, value, row, index) {
                        var url = "/Admin/InvoiceOutport/CancelInvoice";
...
$(document).ready(function () {
    ...
    unit.$historyTable.bootstrapTable(Sv.BootstrapTableOption({
        url: "/Admin/InvoiceOutport/GetHistoryData",
        queryParams: function (p) {
            return {
    ...
    unit.$btnOpenAdd.click(function () {
        window.location.href = "/Admin/InvoiceOutport/Add";
    });

    unit.$boxDetails.on('click', 'button#btnSave', function (e) {
        e.preventDefault();
        Sv.AjaxPost({
            Url: "/Admin/InvoiceOutport/Update",
            Data: {
