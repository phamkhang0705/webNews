var Unit = function () {
                ...
                events: {
                    'click .OpenEditItem': function (e, value, row, index) {
                        Sv.ChecPermission("View", function () {
                            var url = "/Admin/ContentTypeManagement/ShowModal";
                            var model = {
    ...
    this.SubmitServer = function (action, id) {
        ...
        var url = "/ContentTypeManagement/Create";
        if (action === "Edit") {
            url = "/ContentTypeManagement/Update";
        }
        if ($form.valid(true)) {
            Sv.AjaxPost({
                Url: url,
...
$(document).ready(function () {
    ...
    unit.$table.bootstrapTable(Sv.BootstrapTableOption({
        url: "/Admin/ContentTypeManagement/GetData",
