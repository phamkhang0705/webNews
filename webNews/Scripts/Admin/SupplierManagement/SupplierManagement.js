var Unit = function () {
                ...
                events: {
                    'click .OpenEditItem': function (e, value, row, index) {
                        Sv.ChecPermission("View", function () {
                            var url = "/Admin/SupplierManagement/ShowModal";
                            var model = {
                                id: row.Id,
                                action: "Edit",
                                status: row.Status,
    ...
    this.SubmitServer = function (action, id) {
        ...
        if ($form.valid()) {
            ...
            var url = "/SupplierManagement/Create";
            if (action === "Edit") {
                url = "/SupplierManagement/Update";
            }
    ...
    this.GetDistrictByProvinceId = function (provinceId, districtId, controlSelect, optionAll) {
        Sv.AjaxPost({
            Url: '/SupplierManagement/GetDistrictByProvinceId',
            Data: {
    ...
    this.GetWardByDistrictId = function (districtId, wardId, controlSelect, optionAll) {
        Sv.AjaxPost({
            Url: '/SupplierManagement/GetWardByDistrictId',
            Data: {
...
$(document).ready(function () {
    ...
    unit.$table.bootstrapTable(Sv.BootstrapTableOption({
        url: "/Admin/SupplierManagement/GetData",
